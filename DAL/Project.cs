...
namespace Interwebsite.DAL
{
	...
	public partial class Project
	{
		...
		/// 得到一个对象实体
		/// </summary>
		public Interwebsite.Model.Project GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,ProjectName,ProjectInfo,RecruitGuide,CreateTime,ModifyTime from Project ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Interwebsite.Model.Project model=new Interwebsite.Model.Project();
		...
		/// 得到一个对象实体
		/// </summary>
		public Interwebsite.Model.Project DataRowToModel(DataRow row)
		{
			Interwebsite.Model.Project model=new Interwebsite.Model.Project();
			if (row != null)
			{
				...
				if(row["RecruitGuide"]!=null)
				{
					model.RecruitGuide=row["RecruitGuide"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,ProjectName,ProjectInfo,RecruitGuide,CreateTime,ModifyTime ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,ProjectName,ProjectInfo,RecruitGuide,CreateTime,ModifyTime ");
			strSql.Append(" FROM Project ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
        ...
        {
            string sql = "select top " + pageSize + " ID,projectname,modifytime FROM project where id not in(select top " + (curPage - 1) * pageSize + " id FROM Attachment order by id DESC) order by id DESC";
