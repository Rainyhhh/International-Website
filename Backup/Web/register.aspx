<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="Interwebsite.register" %>
				...
				<div class="twelve columns mb40">
	                <div class="column-service-wrapper">
	                    <div class="column-service-title-wrapper">
                            ...
                            <div class="gdl-page-left mb0 six columns" style="margin-top:20px;min-height:942px;" >
                            ...
                            <div class="stunning-text-inner-wrapper gdl-border-x bottom">
                                <h1 class="blog-title" style="color:#1bc4de;font-size:17px;">
                                    <span>学习经历<br />(Education Information)</span>
                                </h1>
                                <div class="contact-form-wrapper">
                                    <ol class="forms">
                                      <li class="form-input">
                            ...
                            <div class="stunning-text-inner-wrapper gdl-border-x bottom">
                                <h1 class="blog-title" style="color:#1bc4de;font-size:17px;">
                                    <span>家庭情况<br />(Family Information)</span>
                                </h1>
                                <div class="contact-form-wrapper">
                                    <ol class="forms">
                                      <li class="form-input">
	                    ...
	                    <div class="column-service-title-wrapper">
                                ...
                                <div class="contact-form-wrapper">
                                    <ol class="forms">
                                      <li class="form-input">
                                        <strong>奖惩情况：</strong>
                                        <textarea id="rewardspunisment" runat="server" style="width:100%;height:80px;"></textarea>
                                      </li>
                                      </ol>
                                </div>
                                <h1 class="blog-title" style="color:#1bc4de;font-size:17px;">
                                ...
                                <div class="contact-form-wrapper">
                                    <ol class="forms">
                                      <li class="form-input">
                                        ...
                                        <textarea id="workexp" runat="server" style="width:100%;height:80px; "></textarea>
                                      </li>
                                      </ol>
                                </div>
                        </div>
                        <asp:LinkButton ID="LinkButton1"  CssClass="contact-submit button" 
                            style="float: right; margin-right:45%;" runat="server" 
                            OnClick="registerbtn_Click" BackColor="#1bc4de" ForeColor="White" 
