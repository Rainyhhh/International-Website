<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Interwebsite.Web.background.login" %>
...
<div id="all">
    ...
    <div id="main">
    	<form action="" runat="server" method="post" id="login_form" style="position:relative;top:50px;" >
        <table id="login" runat="server">
        	<tr>
            	<td style="font-family:Consolas;">USERNAME  </td>
            ...
            <tr><td></td><td></td></tr>
            <tr>
            	<td style="font-family:Consolas;">PASSWORD  </td>
            ...
            <tr>
            	...
            	<td style="text-align: left; padding-top: 32px;">
                    <asp:ImageButton ID="ImageButton1" runat="server" 
                        ImageUrl="~/background/images/login.gif" onclick="ImageButton1_Click" />&nbsp;&nbsp;&nbsp;
                    <asp:ImageButton ID="ImageButton2" runat="server" 
                        ImageUrl="~/background/images/cancel.gif" />&nbsp;</td>
            </tr>
        </table>
        </form>
    </div>
