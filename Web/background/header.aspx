<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="header.aspx.cs" Inherits="Interwebsite.Web.background.header" %>
...
<body>
<div id="all">
	<div id="banner"><h1>后台管理</h1></div>
    <div id="nav">
    	<ul>   	
            <li class="active" id="config"><a href="menu.aspx" target="menu">站点首页</a></li>
        </ul>
    </div>
    <div id="main">
    	<div id="welcome">欢迎你回来,Admin! <img src="images/clock.gif" /> 现在时间: 2013年11月14日 星期四   </div>
        <div id="adminop">
            <ul>
