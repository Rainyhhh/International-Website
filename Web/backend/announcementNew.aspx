<%@ Page Title="" Language="C#" MasterPageFile="Manage.Master" AutoEventWireup="true" CodeBehind="announcementNew.aspx.cs" Inherits="Interwebsite.Web.backend.announcementNew" %>
	                ...
	                <div class="column-service-wrapper">
	                    <div class="column-service-title-wrapper">
	                        ...
	                        <h2 class="column-service-title" style="position:relative;margin-top:-30px;margin-left:50px;">
	                            新建公告<span class="sub-title">New</span>
	                        </h2>
                        </div>
                    </div>
                </div>
