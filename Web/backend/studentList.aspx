<%@ Page Title="" Language="C#" MasterPageFile="Manage.Master" AutoEventWireup="true" CodeBehind="studentList.aspx.cs" Inherits="Interwebsite.Web.backend.studentList" %>
                    ...
                    <div class="twelve columns mb40">
                        <div class="column-service-wrapper">
                            <div class="column-service-title-wrapper">
                                ...
                                <h2 class="column-service-title" style="position: relative; margin-top: -30px; margin-left: 50px;">查询学生信息<span class="sub-title">View</span>
                                </h2>
