<%@ Page Title="" Language="C#" MasterPageFile="Manage.Master" AutoEventWireup="true" CodeBehind="downloadDelete.aspx.cs" Inherits="Interwebsite.Web.backend.downloadDelete" %>
	                ...
	                <div class="column-service-wrapper">
	                    <div class="column-service-title-wrapper">
	                        ...
	                        <h2 class="column-service-title" style="position:relative;margin-top:-30px;margin-left:50px;">
	                            删除文档<span class="sub-title">Delete</span>
	                        </h2>
